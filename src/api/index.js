// Дополнительно заводим объект для работы с API через который будут проходить все запросы.
// На момент реализации фронт части, наличие бэкенда абсолютно не нужно,
// поэтому можно использовать статические данные:
